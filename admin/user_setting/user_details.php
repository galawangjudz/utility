...
if(isset($_POST['new_update']))
{
    ...
    $result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Department='$department', Phonenumber='$phonenumber' where emp_id='$empid'         
		")or die(mysqli_error());
    if ($result) {
     	echo "<script>alert('Your records Successfully Updated');</script>";
		echo "<script>location.replace(_base_url_+'admin/?page=my_profile');</script>";
...
if (isset($_POST["update_image"])) {
    ...
    $result = mysqli_query($conn,"update tblemployees set location='$location' where emp_id='{$_GET['id']}'         
		")or die(mysqli_error());
    if ($result) {
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<?php $query= mysqli_query($conn,"select * from tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentShortName where emp_id = '{$_GET['id']}'")or die(mysqli_error());
									...
									<div class="tab-content">
										...
										<div class="tab-pane fade show active" id="setting" role="tabpanel">
											...
											<div class="profile-setting">
												<form method="POST" enctype="multipart/form-data" action="<?php echo base_url ?>admin/?page=user_setting/user_details">
													<div class="profile-edit-list row">
														<div class="col-md-12"><h4 class="text-blue h5 mb-20">Edit Your Personal Setting</h4></div>

														<?php
														$query = mysqli_query($conn,"select * from tblemployees where emp_id = '{$_GET['id']}' ")or die(mysqli_error());
														$row = mysqli_fetch_array($query);
														?>
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<select name="department" class="custom-select form-control" required="true" autocomplete="off">
																	<?php
																		$query_staff = mysqli_query($conn,"select * from tblemployees join  tbldepartments where emp_id = '{$_GET['id']}'")or die(mysqli_error());
