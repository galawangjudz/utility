...
if (isset($_GET['delete'])) {
	...
	if ($result) {
		...
		echo "<script>location.replace(_base_url_+'admin/?page=user_setting');</script>";
			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_hod = mysqli_query($conn,"select * from tblemployees where role = 'Head' ")or die(mysqli_error());
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-primary weight-500">Supervisor</div>
							</div>
							<div class="widget-icon">
								<div class="icon"><i class="icon-copy fa fa-hourglass" aria-hidden="true"></i></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_cas = mysqli_query($conn,"select * from tblemployees where role = 'Cashier' ")or die(mysqli_error());
						 $count_reg_cas= mysqli_num_rows($query_reg_cas);
						 ?>

						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($count_reg_cas); ?></div>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentShortName where role != 'Admin' ORDER BY tblemployees.emp_id DESC") or die(mysqli_error());
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item edit_data" href="javascript:void(0)" id_emp="<?php echo $emp_id ;?>"><i class="dw dw-edit2"></i> Edit</a>
...
<script>
    $(document).ready(function(){
        ...
        $('#create_new').click(function(){
			uni_modal_2("Add New Employee","user_setting/manage_user.php",'mid-large')
		})
        $('.edit_data').click(function(){
			uni_modal_2("Update Employee Details","user_setting/manage_user.php?id="+$(this).attr('id_emp'),'mid-large')
		})
