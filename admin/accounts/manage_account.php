        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="date" name="date_applied" id="date_applied" class="form-control form-control-border" value ="<?php echo isset($date_applied) ? $date_applied : date('Y-m-d'); ?>" required>
