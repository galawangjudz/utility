                ...
                <style>
                    ...
                    <?php
                        $grandTotal= "SELECT 
                            transaction_date,
                            branch,
                            SUM(c_st_amount_paid) AS Total FROM
                            (
                            SELECT
                    ...
                    GROUP BY
                        transaction_date, branch ORDER BY
                ...
                <div style="height: 500px; overflow-y: auto;">
                    <table id="car_table" class="table table-hover table-bordered">
                        ...
                        while ($grandTotalRow = odbc_fetch_array($result3)):
                            ...
                            <td class="text-right"><?php $grandTotalRow['branch']?></td>
                            <td class="text-right"><?php echo format_num($grandTotalRow['total']) ?></td>  
