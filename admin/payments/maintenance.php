...
<form action="" id="mtf-pay-form">
        ...
        <div class="row">
			<div class="col-md-6">
            <div class="form-group">
                    <label for="main_pay_date" class="control-label">Pay Date</label>
                    <input type="date" name="main_pay_date" id="main_pay_date" class="form-control form-control-border" value ="<?php echo date('Y-m-d'); ?>" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                <label for="gcf_or" class="control-label">Or No.</label>
                <input type="text" name="gcf_or" id="gcf_or" class="form-control form-control-border" placeholder= "ex.CAR153245" value ="" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
			<div class="col-md-6">
            <div class="form-group">
                    <label for="main_discount" class="control-label">Discount</label>
                    <input type="text" name="main_discount" id="main_discount" class="form-control form-control-border" value ="0" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                <label for="main_amount_paid" class="control-label">Amount Paid</label>
                <input type="text" name="main_amount_paid" id="main_amount_paid" class="form-control form-control-border" value ="0" required>
                </div>
            </div>
        </div>
...
<script>
    $(function(){
        $('#uni_modal #mtf-pay-form').submit(function(e){
            e.preventDefault();
            var _this = $(this)
            $('.pop-msg').remove()
            var el = $('<div>')
            ...
            start_loader();
            $.ajax({
                url:_base_url_+"classes/Master.php?f=save_mtf_payment",
