...
<form action="" id="stl-pay-form">
        ...
        <div class="row">
			<div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" name="stl_due" id="stl_due" class="form-control form-control-border" value ="<?php echo isset($street_due) ? $street_due : date('Y-m-d'); ?>" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="stl_balance" id="stl_balance" class="form-control form-control-border" value ="<?php echo isset($stl_bal) ? $stl_bal : '0.00' ?>" required>
        ...
        <div class="row">
			<div class="col-md-6">
            <div class="form-group">
                    <label for="stl_pay_date" class="control-label">Pay Date</label>
                    <input type="date" name="stl_pay_date" id="stl_pay_date" class="form-control form-control-border" value ="<?php echo date('Y-m-d'); ?>" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                <label for="stl_or_no" class="control-label">Or No.</label>
                <input type="text" name="stl_or_no" id="stl_or_no" class="form-control form-control-border" value ="" placeholder= "ex. CAR12345" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
			<div class="col-md-6">
            <div class="form-group">
                    <label for="stl_discount" class="control-label">Discount</label>
                    <input type="text" name="stl_discount" id="stl_discount" class="form-control form-control-border" value ="0" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                <label for="stl_amount_paid" class="control-label">Amount Paid</label>
                <input type="text" name="stl_amount_paid" id="stl_amount_paid" class="form-control form-control-border" value ="0" required>
                </div>
            </div>
        </div>
...
<script>
    $(function(){
        $('#uni_modal #stl-pay-form').submit(function(e){
            e.preventDefault();
            var _this = $(this)
            $('.pop-msg').remove()
            var el = $('<div>')
            ...
            start_loader();
            $.ajax({
                url:_base_url_+"classes/Master.php?f=save_stl_payment",
