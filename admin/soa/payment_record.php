...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		...
		<!-- 	<a href="javascript:void(0)" id="print_record" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-print"></span>Print</a>
	 -->	</div>
	</div>
    ...
    <div class="callout border-primary shadow rounded-0">
        ...
        <div class="row align-items-end">
            <div class="col-md-2 form-group">
                <label for="from" class="control-label">Bill Type</label>
        </div>
            <div class="col-md-4 form-group">
                <select name="bill_type" id="bill_type" class="form-control">
                    <option value= "" selected> All</option>
                    <option value= "MTF" selected> Maintenance</option>
                    <option value= "STL" selected> Streetlight</option>
                </select>
              
            </div>
            <div class="col-md-4 form-group">
                <button class="btn btn-default bg-gradient-navy btn-flat btn-sm" id="filterButton"><i class="fa fa-filter"></i> Filter</button>
                ...
                <table style="width:100%;">
                    <tr>
                        ...
                        WHERE c_account_no = '$l_acc_no' group by c_account_no";
                         ...
                         $summ_count = odbc_num_rows($result);
                         if ($summ_count == 0) {
                             throw new Exception("No due records found! Please Update Billing records!");
                         }else{
                        ...
                        <td style="font-size:14px;"><label class="control-label">Streetlight Balance: </label></td>
                        <td><input type="text" class= "form-control-sm" name="tot_prin" id="tot_prin" value="<?php echo isset($total_stl_bal) ? $total_stl_bal: ''; ?>" disabled></td>
                        <td style="font-size:14px;"><label class="control-label">Maintenance Balance: </label></td>
                        <td><input type="text" class= "form-control-sm" name="tot_sur" id="tot_sur" value="<?php echo isset($total_utl_bal) ? $total_utl_bal : ''; ?>" disabled></td>
