  ...
  <form action="" id="request-form"> 
      ...
      <div class="form-group row">
            ...
            <div class="col-sm-12">
              ...
              <select name="department" class="custom-select form-control" required="true" autocomplete="off" readonly>
                <?php
                if (!empty($dept)) {
          ...
          <div class="col-sm-12">
              <select class="form-control form-control-border" name="request" id="request" readonly>
          ...
          <div class="col-sm-12">
              ...
              <input type="text" id="account_no" name="account_no"autocomplete="off" class="form-control" placeholder="" value="<?php echo isset($acc_no) ? $acc_no : ''; ?>" readonly>
          </div>
          <div class="col-sm-12" id="accountto_row">
              <label for="account_no_to" id="account_no_to_label">Account No To</label>
              <input type="text" id="account_no_to" name="account_no_to"autocomplete="off" class="form-control" placeholder="" value="<?php echo isset($acc_no_to) ? $acc_no_to : NULL; ?>" readonly>
          </div>
          ...
          <div class="col-sm-12" id="amount_row">
                    ...
                    <input type="number" name="amount" id="amount" class="form-control form-control-border" value ="<?php echo isset($amount) ? $amount : ''; ?>" readonly>
          ...
          <div class="col-sm-12" id="gcf_edaterow">
                    ...
                    <input type="date" name="gcf_edate" id="gcf_edate" class="form-control form-control-border" value ="<?php echo isset($gcf_edate) ? $gcf_edate : ''; ?>" readonly>
                    <!-- <small class="text-danger">Amount must be higher than 0.</small> -->
          </div>
      ...
      <div class="form-group row">
          ...
          <div class="form-radio">
              ...
              <div class="radio radiofill radio-inline">
                  <label>
                      <input type="radio" name="priority" value="Highest" <?php echo (isset($priority) && $priority == 'Highest') ? 'checked' : ''; ?> readonly>
                      <i class="helper"></i>Highest
                  </label>
              </div>
              <div class="radio radiofill radio-inline">
                  <label>
                      <input type="radio" name="priority" value="High" <?php echo (isset($priority) && $priority == 'High') ? 'checked' : ''; ?> readonly>
                      <i class="helper"></i>High
                  </label>
              </div>
              <div class="radio radiofill radio-inline">
                  <label>
                      <input type="radio" name="priority" value="Normal" <?php echo (isset($priority) &&  $priority == 'Normal') ? 'checked' : ''; ?> readonly>
                      <i class="helper"></i>Normal
                  </label>
              </div>
              <div class="radio radiofill radio-inline">
                  <label>
                      <input type="radio" name="priority" value="Low" <?php echo (isset($priority) &&  $priority == 'Low') ? 'checked' : ''; ?> readonly>
          ...
          <div class="col-sm-12">
                <textarea rows="3" name="purpose" id="purpose" class="form-control form-control-md rounded-0" readonly><?php echo isset($purpose) ? html_entity_decode($purpose) : '' ?></textarea>
