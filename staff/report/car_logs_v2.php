                    ...
                    <table id="car_table" class="table table-hover table-bordered">
                        ...
                        <tbody>
                            <?php 
                                ...
                                WHERE date(y.date_encoded) BETWEEN '$from' AND '$from'
                                    AND (
                                    ...
                                    FROM
                                        (
                                            ...
                                            WHERE
                                                ...
                                                AND date(y.date_encoded) BETWEEN '$from' AND '$from' AND (c_mop = 3 or c_mop = 4 OR c_mop = 2) AND y.c_encoded_by ='$encoder'
                                        ) AS Subquery
                                    GROUP BY
                                        branch
                                    ORDER BY
...
<script>
	...
	$(document).ready(function(){
        $('#filter').submit(function(e){
            e.preventDefault()
            location.href="<?php echo base_url ?>staff/?page=report/car_logs_v2&"+$(this).serialize();
