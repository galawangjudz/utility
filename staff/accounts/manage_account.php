        ...
        <div class="row">
			<div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="lname" id="lname" class="form-control form-control-border" placeholder="Enter Last Name" value ="<?php echo isset($last_name) ? $last_name : '' ?>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="fname" class="control-label">First Name  *</label>
                    <input type="text" name="fname" id="fname" class="form-control form-control-border" placeholder="Enter First Name" value ="<?php echo isset($first_name) ? $first_name : '' ?>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
